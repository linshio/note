...
**如果method为空，则不管是post还是get请求都能够通过**
...
解决获取请求参数的乱码问题，可以使用SpringMVC提供的编码过滤器CharacterEncodingFilter，但是必须在web.xml中进行注册，也就是将源码中的encoding设置为utf-8，forceResponseEncoding设置为true
